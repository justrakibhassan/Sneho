...
export const getUserById = async (req: Request, res: Response) => {
  try {
    ...
    res.status(200).json({ success: true, user: user as any });
  } catch (error) {
    res.status(500).json({ message: "Server Error" });
  }
};
...
export const getAllBookings = async (req: Request, res: Response) => {
  try {
    ...
    res.json({ success: true, data: bookings as any });
  } catch (error) {
    console.error(error);
...
export const getPendingSitters = async (req: Request, res: Response) => {
  try {
...
export const approveSitter = async (req: Request, res: Response) => {
  try {
    const { id } = req.params;
...
export const rejectSitter = async (req: Request, res: Response) => {
  try {
    const { id } = req.params;
