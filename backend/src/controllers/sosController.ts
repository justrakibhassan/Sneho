...
export const createSOS = async (req: Request, res: Response) => {
  try {
    ...
    res.status(201).json({
      success: true,
      message:
        "SOS Alert triggered successfully. Emergency services and admins have been notified.",
      data: sosAlert as any,
    });
  } catch (error) {
...
export const getSOSAlerts = async (req: Request, res: Response) => {
  try {
    ...
    res.status(200).json({ success: true, data: alerts as any });
  } catch (error) {
...
export const resolveSOS = async (req: Request, res: Response) => {
  try {
    ...
    res
      .status(200)
      .json({ success: true, message: "SOS Alert resolved", data: alert as any });
  } catch (error) {
