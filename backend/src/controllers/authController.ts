...
// @access  Public
export const registerSitter = async (req: Request, res: Response) => {
  try {
    const {
      name,
      email,
...
export const applyAsSitter = async (req: Request, res: Response) => {
  try {
    ...
    if (!hourlyRate) errors.push("Hourly rate is required");
    if (!bio) errors.push("Bio is required");
    if (!skills) errors.push("Skills are required");
    if (!location) errors.push("Location is required");
    if (!gender) errors.push("Gender is required");
    if (!dob) errors.push("Date of Birth is required");
    if (!phoneNumber && !user.phoneNumber) errors.push("Phone number is required");
    if (!profilePicture && !user.profilePicture) errors.push("Profile picture is required");
